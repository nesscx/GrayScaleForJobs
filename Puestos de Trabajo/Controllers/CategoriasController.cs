...
namespace Puestos_de_Trabajo.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "id,descripcion")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "id,descripcion")] Categoria categoria)
        {
            if (ModelState.IsValid)
            {
